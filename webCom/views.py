...
MODEL_CONFIGS = {
    ...
    "job-applications": {"model": JobApplication, "form": JobApplicationForm, "title": "Job Applications", "icon": "JA", "fields": ["job", "application_mode", "applicant_name", "phone_number", "email", "resume", "status", "submitted_at"], "detail_fields": ["job", "application_mode", "applicant_name", "phone_number", "email", "address", "qualification", "experience_summary", "cover_note", "resume", "received_by", "status", "submitted_at", "updated_at"], "required_only": False},
    "job-application-notifications": {"model": JobApplicationNotification, "form": None, "title": "Application Notifications", "icon": "AN", "fields": ["application", "recipient", "recipient_group", "status", "notified_at"], "detail_fields": ["application", "recipient", "recipient_group", "notification_type", "message", "status", "delivery_note", "notified_at", "created_at", "updated_at"], "managed_table": True, "managed_message": "Application notifications are created automatically when online applications are submitted."},
    ...
    "incidents": {
        ...
        "title": "Incidents",
        "icon": "IN",
        "fields": ["incident_type", "site", "severity_level", "status", "date_time"],
        "required_only": False,
        "detail_fields": [
            "incident_id",
            "site",
...
DEPARTMENTS = [
    ...
    {"name": "Human Resources", "items": ["employees", "job-postings", "job-applications", "job-application-notifications", "training", "leaves", "disciplinary-actions", "performance-evaluations", "documents"]},
